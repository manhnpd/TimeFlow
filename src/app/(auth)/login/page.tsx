  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center p-6 relative overflow-hidden">
      ...
      <motion.div
        ...
        className="relative z-10 w-full max-w-[440px] bg-card/60 backdrop-blur-xl border border-white/5 p-8 sm:p-10 rounded-2xl shadow-2xl"
      >
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-muted-foreground text-sm mt-1">Chào mừng bạn trở lại!</p>
        </div>
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          <div className="space-y-1.5">
            ...
            <div className="relative group">
              ...
              <Input
                ...
                className="h-12 pl-12 bg-secondary border-border/50 rounded-xl focus:border-primary"
                required
              />
            </div>
          </div>
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative group">
              ...
              <Input
                ...
                className="h-12 pl-12 pr-12 bg-secondary border-border/50 rounded-xl focus:border-primary"
                required
              />
              <button
                type="button"
          ...
          <Button
            type="submit"
            className="w-full h-12 bg-primary text-primary-foreground font-bold rounded-xl hover:bg-primary/90 shadow-lg shadow-primary/20 active:scale-[0.98] mt-4"
            disabled={loading}
          >
        ...
        <div className="flex items-center gap-4 my-8">
          ...
          <span className="text-xs text-muted-foreground font-medium">Hoặc đăng nhập với</span>
          <div className="h-px flex-1 bg-border" />
        </div>

        <div className="grid grid-cols-2 gap-4">
          <button className="flex items-center justify-center gap-2 h-12 border border-border rounded-xl bg-secondary/50 hover:bg-secondary text-foreground transition-all text-sm font-medium active:scale-[0.98]">
